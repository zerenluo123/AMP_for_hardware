...
OUTPUT_DIR = "{LEGGED_GYM_ROOT_DIR}/datasets/mocap_motions_go1_biped".format(
    LEGGED_GYM_ROOT_DIR=LEGGED_GYM_ROOT_DIR)
...
MOCAP_MOTIONS = [
    ...
    [
        "biped_3",
        "{LEGGED_GYM_ROOT_DIR}/datasets/keypoint_datasets/ai4animation/dog_beg00_joint_pos.txt".format(
            LEGGED_GYM_ROOT_DIR=LEGGED_GYM_ROOT_DIR), 1525, 1725, 1.0
    ],
    [
        "biped_4",
        "{LEGGED_GYM_ROOT_DIR}/datasets/keypoint_datasets/ai4animation/dog_beg00_joint_pos.txt".format(
            LEGGED_GYM_ROOT_DIR=LEGGED_GYM_ROOT_DIR), 2670, 2733, 1.5
    ],
